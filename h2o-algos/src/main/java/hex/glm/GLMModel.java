...
public class GLMModel extends Model<GLMModel,GLMModel.GLMParameters,GLMModel.GLMOutput> {
  ...
  public static class GLMParameters extends Model.Parameters {
    ...
    public void validate(GLM glm) {
      ...
      if (_solver.equals(Solver.IRLSM_SPEEDUP) && !_family.equals(Family.multinomial))
        glm.error("IRLSM_SPEEDUP", "is only available for the multinomial family.");
...
//        case multinomial: // should not be used
    ...
    public static enum Solver {AUTO, IRLSM, IRLSM_SPEEDUP, IRLSM_SPEEDUP2, L_BFGS, COORDINATE_DESCENT_NAIVE,
