...
public class GLM extends ModelBuilder<GLMModel,GLMParameters,GLMOutput> {
  ...
  protected void checkMemoryFootPrint(DataInfo activeData) {
    if (_parms._solver.equals(Solver.IRLSM) || _parms._solver.equals(Solver.COORDINATE_DESCENT) || 
            _parms._solver.equals(Solver.IRLSM_SPEEDUP) || _parms._solver.equals(Solver.IRLSM_SPEEDUP2)) {
      ...
      if ( _parms._solver.equals(Solver.IRLSM_SPEEDUP) || _parms._solver.equals(Solver.IRLSM_SPEEDUP2)) {
        mem_usage = mem_usage*_nclass;  // increase this for native multinomial implementation
      }
    ...
    if(_response != null) {
      ...
      switch (_parms._family) {
        ...
        case multinomial:
          ...
          else if (_parms._solver.equals(Solver.IRLSM_SPEEDUP) || _parms._solver.equals(Solver.IRLSM_SPEEDUP2)) {
            if (!_parms._intercept)
...
//          if (_nclass != 1) error("_family", H2O.technote(2, "Gaussian requires the response to be numeric."));
  ...
  public final class GLMDriver extends Driver implements ProgressMonitor {
    ...
    private void fitIRLSM_multinomial(Solver s) {
      ...
      } else if (s.equals(Solver.IRLSM_SPEEDUP) || s.equals(Solver.IRLSM_SPEEDUP2)) {
    ...
    private void fitIRLSMSPEEDUP_multinomial(Solver s) {
      ...
      do {
        ...
        firstIter = iterCount < MULTINOMIAL_LS_ITER; // need this for backtracing line search
        for (int classInd = 0; classInd < _nclass; classInd++) {
...
//      _ginfo = new ProximalGradientInfo(ginfo,ginfo._objVal,ginfo._gradient);
  ...
  public static final class GLMGradientSolver implements GradientSolver {
    ...
    public GLMGradientInfo getGradient(double[] beta) {
      if (_parms._solver.equals(Solver.IRLSM_SPEEDUP) || _parms._solver.equals(Solver.IRLSM_SPEEDUP2)) { // do thing natively here
