...
class H2OXGBoostEstimator(H2OEstimator):
    ...
    def __init__(self, **kwargs):
        ...
        names_list = {"model_id", "training_frame", "validation_frame", "nfolds", "keep_cross_validation_models",
                      ...
                      "categorical_encoding", "quiet_mode", "checkpoint", "export_checkpoints_dir", "ntrees",
                      ...
                      "min_split_improvement", "gamma", "nthread", "max_bins", "max_leaves", "min_sum_hessian_in_leaf",
                      "min_data_in_leaf", "sample_type", "normalize_type", "rate_drop", "one_drop", "skip_drop",
